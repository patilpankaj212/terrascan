...
<testsuites tests="566" name="TERRASCAN_POLICY_SUITES" failures="1" time="0">
  <testsuite tests="566" failures="1" time="0" name="TERRASCAN_POLICY_SUITE" package="test">
    <properties>
      <property name="Terrascan Version" value="v1.3.1"></property>
    </properties>
    <testcase classname="s3EnforceUserACL" name="AWS.S3Bucket.DS.High.1043" file="modules/m1/main.tf" severity="HIGH" line="20" category="S3">
      <failure message="Description: S3 bucket Access is allowed to all AWS Account Users., File: modules/m1/main.tf, Line: 20, Severity: HIGH, Rule Name: s3EnforceUserACL, Rule ID: AWS.S3Bucket.DS.High.1043, Resource Name: bucket, Resource Type: aws_s3_bucket, Category: S3" type="HIGH"></failure>
    </testcase>
    <testcase classname="s3EnforceUserACL" name="AWS.S3Bucket.DS.High.1043" file="modules/m1/main.tf" severity="HIGH" line="20" category="S3">
